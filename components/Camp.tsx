...
const Camp = () => {
  return (
    <section className="2xl:max-container relative flex flex-col py-10 lg:m-10 lg:py-20 xl:mb-20">
      ...
      <div className="lg:absolute lg:right-0 flexEnd mt-10 px-6 lg:mt-60 xl:mt-96 lg:mr-6">
